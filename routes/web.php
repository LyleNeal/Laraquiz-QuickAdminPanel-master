...
$this->get('auth/google', 'Auth\Oauth2Controller@oauth2google')->name('oauth2google');
$this->get('auth/google/callback', 'Auth\Oauth2Controller@googlecallback')->name('googlecallback');
...
$this->post('password/reset', 'Auth\ResetPasswordController@postReset')->name('auth.password.reset');
